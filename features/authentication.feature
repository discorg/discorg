Feature: User can register and manage their sessions
  ...
  Scenario: User can register and start a session
    ...
    When user registers with email address "ondrej@bouda.life" and password "secret"
    And user starts a session with email address "ondrej@bouda.life" and password "secret"
